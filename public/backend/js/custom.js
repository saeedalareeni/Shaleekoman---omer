$(document).ready(function (){
    ...
    let calculate_tax = function (){
        ...
        // let discountVal = sub_totalVal - discount ;


        let tax_value = (sub_totalVal - discount) *  0.05;
    ...
    $('#btn_add').click(function() {
        ...
        let template =
            `<tr class="cloning_row">
                        ...
                        <td>
                            <input type="text" step="any" class="form-control product_name"  name="product_name[]" id="product_name" required >
                        </td>

                         <td>
                            <input type="number"  step="any" class="form-control quantity" name="quantity[]" id="quantity" required>
                        </td>

                        <td>
                            <input type="number"  step="any" class="form-control unit_price" name="unit_price[]" id="unit_price" required>
                        </td>

                        <td>
                            <input type="number" value="0.00"  step="any" class="form-control row_sub_total" id="row_sub_total"  name="row_sub_total[]" readonly >
                        </td>
                    </tr>`;
