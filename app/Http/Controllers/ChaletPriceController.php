...
class ChaletPriceController extends Controller {
    ...
    public function index(Chalet $chalet)
    {
        // Retrieve the price
        $price = $chalet->default_day_price;
        return view('backend.pages.chalets.prices', compact('chalet', 'price'));
    }
    ...
    public function updatePrices(Request $request, Chalet $chalet)
    {
        ...
        return redirect()->route('chalets.prices.index', $chalet->id)->with('success', 'تم تحديث الأسعار بنجاح');
    }
    ...
    public function updatePricesRecurrence(Request $request, Chalet $chalet)
    {
        ...
        return redirect()->route('chalets.prices.index', $chalet->id)->with('success', 'تم تحديث الأسعار للأيام المحددة بنجاح');
    }
