...
@section('content')
    ...
    <div class="row">
        ...
        <div class="container mt-4">
            ...
            <form action="{{ route('chalets.images.store', $chalet->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row justify-content-center">
                    @foreach($chalet->images as $image)
                        <div class="col-md-3 mb-3 text-center">
                            ...
                            <form action="{{ route('chalets.images.destroy', $image->id) }}" method="POST" class="mt-2">
                                @csrf
                                @method('DELETE')
