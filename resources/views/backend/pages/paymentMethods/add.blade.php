    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('back.payment_methods_add')}}</h5>
            ...
            <div class="modal-body">
                ...
                <form action=" {{ route('paymentsMethod.store') }}" method="post" enctype="multipart/form-data">
                @csrf
