<!-- Modal -->
<div class="modal fade" id="delete_order{{$order->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body text-left">
                ...
                <form action="{{route('booking-customers.destroy', $order->id)}}" method="post">
                    @csrf
                    @method('DELETE')
