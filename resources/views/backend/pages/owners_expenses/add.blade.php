<!-- Modal -->
<div class="modal fade" id="add_owners_expense" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('back.add_owners_expense')}}</h5>
            ...
            <div class="modal-body">
                ...
                <form action=" {{ route('owners_expenses.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control expense_amount" step="any" placeholder="{{trans('back.amount')}}"  name="amount" value="{{($totalAmount - $totalCommission) - $owner->expenses->sum('amount') }}" readonly>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <b class="text-danger">*</b>
                            <input type="date" class="form-control" placeholder=" {{trans('back.expense_date')}}" name="expense_date" value="{{date('Y-m-d')}}">
                        </div>
                        ...
                        <div class="form-group col-md-3" >
                            ...
                            <input type="text" class="form-control" placeholder="{{trans('back.Check_number')}}" name="check_number" value="{{old('check_number')}}" >
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <b class="text-danger">*</b>
                            <input type="text" class="form-control" placeholder="{{trans('back.about')}}" name="about" value="{{old('about')}}">
                        </div>
