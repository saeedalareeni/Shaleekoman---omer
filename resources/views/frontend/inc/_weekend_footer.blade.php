...
<style>
    /* لضمان عدم حدوث تداخل في الشاشات الصغيرة جداً */
    @media (max-width: 767px) {
        .maroof-container .col-12 {
            margin-top: 8px;
        }
    }
    .footer-column {
...
<!-- Maroof Logo & Text -->
                <div class="maroof-container mt-3">
                    <div class="row align-items-center g-2 text-md-start text-center">
                        ...
                        <div class="col-12 col-md-auto">
                            <span style="font-size: 15px; font-weight: 600; color: #20c997; white-space: normal;">
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-content">
            ...
            @endif
            <div class="copyright">
                <span class="footer-copyright-current"><span class="text-secondary">{{ app()->getLocale() == 'ar' ? 'جميع الحقوق محفوظة © 2026' : 'All rights reserved © 2026' }}</span> <span class="text-dark">{{ app()->getLocale() == 'ar' ? 'شاليك' : 'Shaleek' }}</span> <span class="text-secondary">، منصة عرض الشاليهات والمزارع والاستراحات والأكواخ ، لا نوفر خدمة حجوزات ، لسنا مسؤولين عن الحجوزات</span></span>
                <span><span class="text-secondary">{{ app()->getLocale() == 'ar' ? 'جميع الحقوق محفوظة © 2025' : 'All rights reserved © 2025' }}</span> <span class="text-dark">{{ $siteName ?? 'shaleek' }}</span></span>
            </div>
        </div>
    </div>
</footer>
...
<style type="text/css">
    ...
    @media (max-width: 767.98px) {
        ...
        .footer-column.is-open .footer-menu,
        .footer-column.is-open .contact-info{
            max-height: 500px;
            display: block !important;
        }
    }

    /* سلوك الديسكتوب (عادي بدون Dropdown) */
    ...
    .copyright > span:not(.footer-copyright-current) {
        display: none;
    }
</style>
<!-- Footer Scripts -->
