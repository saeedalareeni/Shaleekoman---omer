...
<div class="property-images-grid d-none d-lg-grid">
    ...
    <div class="images-column-small {{ $imageCount == 3 ? 'three-images' : '' }}">
        @if($imageCount > 0)
...
<div class="d-lg-none mobile-layout">
    ...
    <div style="padding: 20px 15px; background: white; margin-bottom: 8px;">
        ...
        <p style="font-size: 0.9rem; line-height: 1.6; color: #444;">
            {{ $isArabic ? $chalet->short_description_ar : $chalet->short_description_en }}
        </p>
        @endif
    </div>
                    ...
                    <form action="{{ route('chalet.book', $chalet->id) }}" method="POST" id="booking-form">
                        ...
                        <div class="payment-options">
                            <div class="payment-option">
                                <img src="{{ asset('frontend/images/tabby.png') }}" alt="Tabby" style="height: 24px;">
                                <span>{{ $isArabic ? 'قسمها على 4. بدون فوائد أو رسوم' : 'Split into 4. No interest or fees' }}</span>
                            </div>
                            <div class="payment-option">
                                <img src="{{ asset('frontend/images/tamara.png') }}" alt="Tamara" style="height: 24px;">
                                <span>{{ $isArabic ? 'قسمها على 4. بدون فوائد أو رسوم' : 'Split into 4. No interest or fees' }}</span>
                            </div>
                            <div class="payment-option">
                                <img src="{{ asset('frontend/images/qitaf.png') }}" alt="STC" style="height: 24px;">
                                <span>{{ $isArabic ? 'اكسب' : 'Earn' }} <span class="fw-bold">{{ number_format($chalet->default_day_price * 0.1, 0) }} {{ $isArabic ? 'نقطة' : 'points' }}</span> {{ $isArabic ? 'مع stc قطاف' : 'with STC Qitaf' }}</span>
                            </div>
                        </div>
                    </form>
                </div>
