<!-- Modal -->
<div class="modal fade" id="cancel_booking{{$booking->booking_number}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('back.cancel_booking')}} {{ $booking->booking_number }}</h5>
