...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <form action="{{ route('owner.chalets.update', $chalet->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    ...
                                    <img src="{{ asset($chalet->main_image??'no_image.png') }}" class=" avatar-sm" alt="">
                                </div>
                            </div>
                        </div>
